...
------------------------------ */
const ArrType_65: React.FC<Props> = ({ data:rows, hint }:any) => {
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 gap-x-12 gap-y-3 md:grid-cols-2">
        {data.map((r, i) => (
          ...
          >
            <span className="tabular-nums">{toGBP(r.a)}m</span>
            <span className="text-slate-700">+</span>
            <span className="tabular-nums">{toGBP(r.b)}m</span>
            <span className="text-slate-700">=</span>
